<?php
    ...
    require_once "conexion.php";
        ...
        FROM `aux_tareas2` as t2 INNER JOIN tareas as ts ON ts.id = t2.`id_tarea` INNER JOIN presupuestos2 as ps2 ON ps2.id = ts.id_pres
        ...
        INNER JOIN cuentas as c ON c.id_user = t2.`id_cuenta` where t2.`id_a` = $id");
