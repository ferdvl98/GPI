...
require_once "conexion.php";
  ...
  $consulta = $link->query("SELECT at3.`id`, py.nombre as proyecto, ps.nombre as presupuesto, t.nombre as tipo, a.nombre as area, d.nombre as dis,
    ps2.concepto, at3.`presupuesto` as total , c.nombre as responsable FROM `aux_tareas3` as at3 INNER JOIN tareas2 as t2 ON t2.id = at3.`id_tarea`
  ...
  while ($registro = mysqli_fetch_array($consulta)) {
    ...
    $sql2 = "SELECT sum(`presupuesto`) as a FROM `aux_tareas3` WHERE id_a = $id";
